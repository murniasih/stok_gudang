...
<body>
   ...
   <div class="col-md-10" style="min-height:600px">
         <div class="col-md-12" style="padding:10px; padding-left:0;padding-right:0;">
            <a href="tambahbarangmasuk.php" class="btn btn-info">+</a>
         </div>
		...
		if(mysqli_num_rows($result) == 0){
			...
			while($data = mysqli_fetch_assoc($result)){					
				...
				echo '<tr>';
					...
					echo '<td><a href="edit_barang_masuk.php? id_transaksi_masuk='.$data['id_transaksi_masuk'].'" class="fa fa-edit fa-fw" ></a> &nbsp | &nbsp <a href="hapus_barang_masuk.php? id_transaksi_masuk='.$data['id_transaksi_masuk'].'" class="fa fa-trash-o fa-fw" onclick="return confirm(\'Apakah Data Akan dihapus??\')"></a></td>';	//menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?id=siswa_id
				echo '</tr>';
				$no++;
			}	
		}
