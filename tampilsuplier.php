...
$query = "SELECT kode_suplier,nama_suplier,alamat,no_telp from tabel_suplier";
...
$judul = "Laporan Data Suplier";
$header = array(
		
		array("label"=>"Kode Suplier", "length"=>27, "align"=>"C"),
		array("label"=>"Nama Suplier", "length"=>70, "align"=>"C"),
		array("label"=>"Alamat", "length"=>27, "align"=>"C"),
		array("label"=>"No Telp", "length"=>27, "align"=>"C")
	);
