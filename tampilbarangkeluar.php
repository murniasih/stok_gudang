...
$query = "SELECT no_faktur,tanggal_keluar,kode_barang,nama_barang,departemen,jumlah_keluar from barang_keluar";
...
$judul = "Laporan Data Pengambilan Barang";
$header = array(
		...
		array("label"=>"Jumlah Keluar", "length"=>27, "align"=>"C"),
