...
<body>
	...
	<div class="col-md-10" style="min-height:500px">
		<div class="col-md-12" style="padding:10px; padding-left:0;padding-right:0;">
			<a href="tambahbarang.php" class="btn btn-info">Tambah</a>
            ...
            <table class="table table-striped">
				...
				if(mysqli_num_rows($result) == 0){
					...
					while($data = mysqli_fetch_assoc($result)){	
						...
						echo '<td><a href="edit_barang.php? id_barang='.$data['id_barang'].'" class="fa fa-edit fa-fw"></a> &nbsp / <a href="hapus_barang.php? id_barang='.$data['id_barang'].'" class="fa fa-trash-o fa-fw" onclick="return confirm(\'Apakah Data Akan dihapus??\')"></a></td>';	//menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?id=siswa_id
						echo '</tr>';
						$no++;
					}	
					}
