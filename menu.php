...
<ul>
   ...
   <li class='has-sub'><a href='#'><i class="fa fa-bars fa-2x"></i>&nbsp; Master</i></a>
            <ul>
               <li><a href="barang.php"><span><i class="fa fa-shield fa-fw"></i>&nbsp; Data Barang</span></a></li>
			   <li><a href="suplier.php"><span><i class="fa fa-users fa-fw"></i>&nbsp; Data Suplier</span></a></li>
			   <li><a href="departemen.php"><span><i class="fa fa-industry"></i>&nbsp; Data Departemen</span></a></li>
			   <li><a href="satuan.php"><span><i class="fa fa-cogs"></i>&nbsp; Data Satuan</span></a></li>
         ...
         <li class='has-sub'><a href='#'><i class="fa fa-database fa-2x"></i>&nbsp; Transaksi</a>
            <ul>
               <li><a href="barang_masuk.php"><i class="fa fa-share fa-fw"></i><span>&nbsp; Barang Masuk</span></a></li>
			   <li><a href="barang_keluar.php"><i class="fa fa-reply fa-fw"></i><span>&nbsp; Barang Keluar</span></a></li>
            </ul>
         </li>
 ...
 <li class='last'><a href="user_corner.php"><i class="fa fa-users fa-2x"></i>&nbsp; User Corner</a></li>
