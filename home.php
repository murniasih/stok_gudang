   ...
   <div class="col-md-10" style="min-height:500px">
			...
			<div class="col-md-3 col-sm-12 col-xs-12">                            
                <div class="panel panel-primary text-center no-boder bg-color-red">
                    <div class="panel-body"style="color:green">
                     ...
                     <div class="panel-footer back-footer-red">
						 <a href="#" class="small-box-footer" style="color:green">
						 7 <i class="fa fa-arrow-circle-right"></i>
						 </a>
                     </div>
                </div>          
			</div>		
	...
	<p>
		<section class="content">     
			<div class="col-md-3 col-sm-12 col-xs-12">                            
                <div class="panel panel-primary text-center no-boder bg-color-red">
                    <div class="panel-body" style="color:purple">
						 <i class="fa fa-users fa-5x"></i>
						 <h3>User </h3>
                     </div>
                     <div class="panel-footer back-footer-red">
						 <a href="#" class="small-box-footer"style="color:purple">
						 3 <i class="fa fa-arrow-circle-right"></i>
						 </a>
                     </div>
                </div>          
